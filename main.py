...
# int_num = 5.7
# print(type(int_num)) #type identifies the type of varible that is put in
# nAme = 'Tony'
# print(type(nAme))
# classinsession = True
...
# money_for_dinner = float(input('How muich dp you have for dinner?'))
# total_cost = money_for_movie + money_for_dinner
# print('Total cost:' + str(total_cost) + ' for the movie and dinner')
...
# implicit means its infered already by the prgram
# # explicit means its explicitly declared

# birthday = input('when is your birthday?')
# print(type(birthday)) #inplicit
# print(int(birthday)) #explcit
